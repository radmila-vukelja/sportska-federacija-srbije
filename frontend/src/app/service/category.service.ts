...
export class CategoryService {
  ...
  edit(category: Category){
    return this.http.put<Category>(this.apiUrl, category, { headers: this.loginService.getHeaders() });
  }

  save(category: Category) {
    return this.http.post<Category>(this.apiUrl, category, { headers: this.loginService.getHeaders() })
  }
